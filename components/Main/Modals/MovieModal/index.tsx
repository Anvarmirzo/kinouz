                    ...
                    <div className="movie-info">
                        <div className="movie-info__header">
                            <div className="movie-info__video">
                                <video id="videoModal-1" className="video-js" controls preload="false"
                                ...
                                <div className="col-12 col-sm-6">
                                    <div className="movie-info__ratings">
                                        <div className="movie-info__rating">
                                            <span className="icon icon-imdb"></span>{rating.imdb}
                                        </div>
                                        <div className="movie-info__rating">
                                            <span className="icon icon-kinopoisk"></span>{rating.kinopoisk}
                                        </div>
                                    </div>
                                    <div className="movie-info__info">2021 <span
                                        className="text-primary">I</span> фантастика,
                                        боевик <span className="text-primary">I</span> США <span
                                    ...
                                    <div className="movie-info__info-item movie-info-item">
                                        ...
                                        <div className="movie-info-item__desc">Тимоти Шаламе, Ребекка
                                            Фергюсон, <br/>Оскар
                                            Айзек, Джош Бролин, Джейсон Момоа <br/>и другие
                                        </div>
                                    </div>
                                </div>
                                <div className="col-12 col-sm-6">
                                    <div className="movie-info__info-item movie-info-item">
                                        ...
                                        <div className="movie-info-item__desc">Человечество расселилось по
                                            далёким
                                            планетам,
                                            а за власть над обитаемым пространством постоянно борются разные
                                            могущественные семьи. В центре противостояния оказывается пустынная
                                            планета
                                            Арракис. Человечество расселилось по далёким планетам, а за власть
                                            над
                                            обитаемым пространством постоянно борются разные могущественные
                                            семьи. В
                                            центре противостояния оказывается пустынная планета Арракис.
                                        </div>
                                    </div>
                                </div>
                            </div>
