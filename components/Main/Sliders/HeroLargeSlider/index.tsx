			...
			>
				<SwiperSlide className='movie-slider__item'>
					<div
						...
						style={{backgroundImage: 'url("/img/dist/main-slider-img.jpg")'}}
					></div>
					<div className='movie-slider__container container-fluid'>
						<div className='movie-slider__text'>
							...
							<div className='movie-slider__desc'>
								Человечество расселилось по далёким планетам, <br />а за власть над обитаемым
								пространством постоянно <br />
								борются разные могущественные семьи. В центре <br />
								противостояния оказывается пустынная планета Арракис.
							</div>
							<div className='movie-slider__btns'>
								<a href='movie.html' className='btn btn-primary btn-icon rounded-pill'>
				...
				<SwiperSlide className='movie-slider__item'>
					<div
						className='movie-slider__img'
						style={{backgroundImage: "url('/img/dist/main-slider-img2.jpg')"}}
					></div>
					<div className='movie-slider__container container-fluid'>
						<div className='movie-slider__text'>
							<div className='movie-slider__name'>
							...
							<div className='movie-slider__desc'>
								Два искателя приключений Нейтан Дрейк и Виктор Салливан по прозвищу Салли
								отправляются на поиски величайшего сокровища мира. Кроме того, они надеются найти
								улики, которые приведут их к давно потерянному брату Нейтана.
							</div>
							<div className='movie-slider__btns'>
								...
								<MovieModal
									movie={{
										...
										title: 'Название фильма',
										video: {
											poster: 'img/dist/main-slider-img2.jpg',
											src: 'video/uncharted.mp4',
										},
									}}
								/>
							</div>
