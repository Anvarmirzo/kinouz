...
export const LoginButtonWithMenu = () => {
    ...
    const toggleOpenFlag = (key: keyof typeof isMenuOpen) => (e: React.MouseEvent<HTMLElement, MouseEvent>) => {
        e.preventDefault()
                ...
                <nav className="user-sidebar__user-sidebar-menu user-sidebar-menu">
                    <ul className="user-sidebar-menu__list">
                        ...
                        <li className="user-sidebar-menu__item hus-sub-list">
                            <a href="#" onClick={toggleOpenFlag('profilesDropdown')}
                            ...
                            <AnimateHeight duration={300} height={height}>
                                <ul
                                    className="user-sidebar-menu__sub-list"
                                    style={{display: 'block'}}
                                >
                        ...
                        <li className="user-sidebar-menu__item">
                            <a href="components/Main/Header/index#"
                               className="user-sidebar-menu__link"><span
