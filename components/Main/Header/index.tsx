                    ...
                    <div className="header__menus">
                        <nav className="header__main-menu main-menu">
                            <ul className="main-menu__list">
                                <li className="main-menu__item"><a href="components/Main/Header/index#" className="main-menu__link">TV</a></li>
                                <li className="main-menu__item main-menu__item_active"><a href="films.html"
                                                                                          className="main-menu__link">Фильмы</a>
                                </li>
                                <li className="main-menu__item"><a href="components/Main/Header/index#" className="main-menu__link">Сериалы</a></li>
                                <li className="main-menu__item"><a href="components/Main/Header/index#" className="main-menu__link">Шоу</a></li>
                                <li className="main-menu__item"><a href="components/Main/Header/index#" className="main-menu__link">Мультфильмы</a>
                                </li>
                                <li className="main-menu__item"><a href="components/Main/Header/index#" className="main-menu__link">Аниме</a></li>
                            </ul>
                        </nav>
                        <nav className="header__user-menu user-menu">
                            <ul className="user-menu__list">
                                <li className="user-menu__item"><a href="components/Main/Header/index#" className="user-menu__link">Моя подборка</a>
                                </li>
                                <li className="user-menu__item"><a href="components/Main/Header/index#" className="user-menu__link">История
                                    просмотров</a></li>
                            </ul>
                        </nav>
                    </div>
                    <div className="header__search">
                        <button className="btn btn-secondary rounded-pill" type="button" data-bs-toggle="modal"
                                data-bs-target="#searchModal"><span className="icon icon-search"></span></button>
                    </div>
                    <div className="header__loginza header-loginza">
                        <button className="header-loginza__login btn btn-primary rounded-pill" type="button"
                                data-bs-toggle="modal" data-bs-target="#loginModal">Войти
                        </button>
                                ...
                                <ul className="user-sidebar-menu__list">
                                    ...
                                    <li className="user-sidebar-menu__item hus-sub-list">
                                        ...
                                        <ul className="user-sidebar-menu__sub-list">
                                            <li className="user-sidebar-menu__sub-item"><a href="components/Main/Header/index#"
