        ...
        <div>
            ...
            <main className="content">
                <section className="page-movie-card margin-under-header">
                    <div className="page-movie-card__img"
                         style={{backgroundImage: 'url("/img/dist/page-movie-img.jpg")'}}></div>
                        ...
                        <div className="page-movie-card__text row">
                            <div className="col-12 col-lg-6 mb-5">
                                ...
                                <div className="page-movie-card__ratings">
                                    <div className="page-movie-card__rating"><span
                                ...
                                <div className="page-movie-card__info">2021 <span
                                    className="text-primary">I</span> фантастика, боевик <span
                                    className="text-primary">I</span> США <span
                                    className="text-primary">I</span> 145 минут <span
                                    className="text-primary">I</span> <span className="text-primary">16+</span>
                                </div>
                                ...
                                <div className="page-movie-card__quality">
                                    <div className="form-check form-check-inline">
                                        ...
                                        <label className="form-check-label" htmlFor="inlineRadio1">CD</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="inlineRadioOptions"
                                               id="inlineRadio2" value="option2"/>
                                        <label className="form-check-label" htmlFor="inlineRadio2">HD</label>
                                    </div>
                                    <div className="form-check form-check-inline">
                                        <input className="form-check-input" type="radio" name="inlineRadioOptions"
                                    ...
                                    <div className="form-check form-check-inline">
                                        ...
                                        <label className="form-check-label" htmlFor="inlineRadio4">UHD4k</label>
                                    </div>
                                </div>
                            </div>
                            <div className="col-12 col-lg-6 mb-5">
                                <div className="page-movie-card__description">
                                    ...
                                    <p>Человечество расселилось по далёким планетам, а за власть над обитаемым
                                        ...
                                        песчаные черви, а в пещерах затаились скитальцы-фремены, но её главная
                                        ценность — пряность, самое важное вещество во Вселенной. Тот, кто
                                        контролирует Арракис, контролирует пряность, а тот, кто контролирует
                                        пряность, контролирует Вселенную. В центре противостояния оказывается
                                        пустынная планета Арракис. Там обитают гигантские песчаные черви, а в
                                        пещерах затаились скитальцы-фремены, но её главная ценность — пряность,
                                        самое важное вещество во Вселенной. Тот, кто контролирует Арракис,
                                        контролирует пряность, а тот, кто контролирует пряность, контролирует
                                        Вселенную.</p>
                                </div>
                            </div>
                        </div>
